...
import com.geekster.InstagramProject.repo.IOtpRepository;
...
public class OtpService {
    ...
    public boolean sentOtp(String email) {
        ...
        OtpUser otpUser2 = new OtpUser(email,encryptedOtp);
        otpRepository.save(otpUser2);
    ...
    public OtpVerificationOutput verifyOtp(String otp, String email) {
        OtpUser otpUser1 = otpRepository.findFirstByUserEmail(email);
        if ( otpUser1 == null ) {
        ...
        boolean isOtpValid = encryptedOtp.equals(otpUser1.getOtp());
